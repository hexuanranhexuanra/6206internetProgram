...
<body>
	<div class="main-scroll" style="display:none;">
		...
		<div class="main-scroll-search">
			<input class="mainsearch" type="text" placeholder="search interested" />
			<button class="scrollsearch-img">
				<img src="img/search.png">
			</button>
			<c:choose>
				<c:when test="${empty USER}">
					<a class="login" style="cursor:pointer;" href="/mooc/login/tologin">Login in &nbsp</a>
					<span>|</span>
					<a href="/mooc/register/home.do">Register</a>
				</c:when>
				<c:otherwise>
					<a class="login" style="cursor:pointer;">Welcome：${USER.userName}</a>
					|<a href="/mooc/login/loginout" style="cursor:pointer;">Log out</a>
				</c:otherwise>
			</c:choose>
		</div>
	</div>
				...
				<c:choose>
					<c:when test="${empty USER}">
						<a class="login" style="cursor:pointer;"
							href="/mooc/login/tologin">Login in&nbsp</a>
						<span>|</span>
						<a href="/mooc/register/home.do">Register</a>
					</c:when>
					<c:otherwise>
				...
				<c:when test="${empty USER}">
					<div class="right-img">
						<img src="img/person.png"><br /> <a
							href="/mooc/login/tologin"><button class="login">Log on</button>
						</a>
					</div>
				</c:when>
				<c:otherwise>
