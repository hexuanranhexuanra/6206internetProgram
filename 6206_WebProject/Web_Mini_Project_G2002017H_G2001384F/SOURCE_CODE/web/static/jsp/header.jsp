		...
		<div class="main-scroll-search">
			...
			<c:choose>
				<c:when test="${empty user}">
					<a class="login" style="cursor:pointer;" href="/moocgd/views/before/login.jsp">Log on&nbsp</a>
					<span >|</span>
					<a href="/moocgd/before/register/home">Register</a>
				</c:when>
				<c:otherwise>
					<a class="login" href="/moocgd/before/index/person" style="cursor:pointer;">Welcome：${user.username}</a>
					|<a href="/moocgd/UserServlet?method=quit" style="cursor:pointer;">Log out</a>
				</c:otherwise>
			</c:choose>
		</div>
	</div>
