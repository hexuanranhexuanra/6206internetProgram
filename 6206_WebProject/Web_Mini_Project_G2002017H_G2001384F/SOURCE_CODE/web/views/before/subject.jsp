...
<div class="debugging-top"></div>
 ...
 $(".scrollsearch-img").click(function(){
     ...
     function dataInfo(data){
        $(".totalren").html('A total of '+data.length+
        '<span style="color:#84b706">'+$(".mainsearch-copy").val()+'</span>'+'related results');
     }
        function notFound(){
           $("#paged").hide();
           $("#biuuu_city_list").html('<div class="not-course-card">'+
               ...
               'Sorry, there is no relevant content of '+
			...
			'<div class="course-main">'+
				...
				'<div class="course-name" style="font-weight: normal;">'+item.courseName+'</div>'+
					   ...
					   ' <div class="totalnumber">'+
					      ...
					      ' <span style="margin-left:10px;">'+item.count+' people joined</span>'+
					    '</div>'+
